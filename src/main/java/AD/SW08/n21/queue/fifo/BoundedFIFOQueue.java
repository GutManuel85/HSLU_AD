 ...
 */
package AD.SW08.n21.queue.fifo;

/**
 * FIFO-Puffer (First In First Out) mit einer begrenzten Kapazität. Der
 * FIFO-Puffer ist thread sicher.
 *
 * @param <T> Element Typ.
 */
public final class BoundedFIFOQueue<T> {
    ...
    /**
     * Ein Element T speichern. Falls der Puffer voll ist, warten bis ein Platz
     * frei wird.
     *
     ...
     * Puffer voll ist, warten bis ein Platz frei wird.
     *
     * @param elem zu speicherndes Element.
    ...
    /**
     * Ein Element T auslesen. Falls der Puffer leer ist, warten bis ein Platz
     * belegt ist.
     *
